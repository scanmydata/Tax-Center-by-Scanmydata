...
- [ ] Όλα τα έντυπα ενός πελάτη ως **ένα ZIP** αντί για πολλά συνημμένα
      (σήμερα κάθε PDF πάει ξεχωριστά· το Gmail κόβει στα 25 MB ανά μήνυμα)
- [ ] Throttle + retry για τα όρια του Gmail (~500 μηνύματα/ημέρα)
