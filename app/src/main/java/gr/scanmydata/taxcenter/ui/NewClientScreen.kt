...
fun NewClientScreen(
    ...
    Column(modifier) {
        TabRow(selectedTabIndex = tab) {
            ...
            Tab(
                selected = tab == 1,
                // Η χειροκίνητη καρτέλα δίπλα μπορεί να είναι γεμάτη και άγραφη.
    ...
    AlertDialog(
        ...
        text = {
            Column(Modifier.heightIn(max = 460.dp).verticalScroll(rememberScrollState())) {
                Step(
                    "1. Εξαγωγή από το Epsilon TaxSystem",
                    "Κεντρικό Μενού → **Εκτυπώσεις** → **Κωδικοί e-Υπηρεσιών**.\n" +
                        "Πάτησε **Επιλογή Όλων**, μετά **Εξαγωγή σε Excel**, και δώσε " +
                        "όνομα και θέση αποθήκευσης.\n\n" +
                        "Βγαίνει ο πλατύς πίνακας «Κωδικοί Υπόχρεων» — αυτό ακριβώς " +
                        "το αρχείο χρειάζεται εδώ.\n\n" +
                        "Οδηγίες με εικόνες: kb.epsilonnet.gr/taxsystem/" +
